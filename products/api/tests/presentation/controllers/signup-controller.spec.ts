import { HttpResponse, Validation, IErrorHandling } from '@/libs/framework/src/presentation/protocols'
import { badRequest, serverError, ok } from '@/libs/framework/src/presentation/helpers'
import { MissingParamError } from '@/libs/framework/src/presentation/errors/missing-param-error'
import { SignUp } from '@/products/api/src/presentation/controllers/signup-controller'
